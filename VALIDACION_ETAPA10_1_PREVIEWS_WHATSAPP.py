...
def main():
    ...
    ok("agregarMensajeUsuarioConAdjuntos(t||(archivos.length>1?'Procesá estos documentos.':'Analizá este archivo.'),archivos);" in JS, 'el envío ya no usa sólo nombres con clip en texto')
